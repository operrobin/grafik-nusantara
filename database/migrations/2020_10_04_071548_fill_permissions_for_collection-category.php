...
class FillPermissionsForCollectionCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCollectionCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.collection-category',
            'admin.collection-category.index',
            'admin.collection-category.create',
            'admin.collection-category.show',
            'admin.collection-category.edit',
            'admin.collection-category.delete',
            'admin.collection-category.bulk-delete',
        ]);
