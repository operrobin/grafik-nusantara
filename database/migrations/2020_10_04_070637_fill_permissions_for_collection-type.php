...
class FillPermissionsForCollectionType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCollectionType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.collection-type.index',
            'admin.collection-type.create',
            'admin.collection-type.show',
            'admin.collection-type.edit',
            'admin.collection-type.delete',
            'admin.collection-type.bulk-delete',
        ]);
